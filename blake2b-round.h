...
#define G3(row1,row2,row3,row4,b0,b1,b2,b3) \
    f1 = _mm256_add_epi64(row1, b0); \
    f1 = _mm256_add_epi64(f1, row2); \
    f4 = _mm256_xor_si256(row4, f1); \
    f4 = _mm256_roti_epi64(f4, -32); \
    f1 = _mm256_add_epi64(f1, b1); \
    f3 = _mm256_add_epi64(row3, f4); \
    f2 = _mm256_xor_si256(row2, f3); \
    f2 = _mm256_roti_epi64(f2, -24); \
    f1 = _mm256_add_epi64(f1, f2); \
    f4 = _mm256_xor_si256(f4, f1); \
    f4 = _mm256_roti_epi64(f4, -16); \
    f3 = _mm256_add_epi64(f3, f4); \
    f2 = _mm256_xor_si256(f2, f3); \
    f2 = _mm256_roti_epi64(f2, -63); \
    f4 = _mm256_permute4x64_epi64(f4, _MM_SHUFFLE(2,1,0,3)); \
    f3 = _mm256_permute4x64_epi64(f3, _MM_SHUFFLE(1,0,3,2)); \
    f2 = _mm256_permute4x64_epi64(f2, _MM_SHUFFLE(0,3,2,1)); \
    f1 = _mm256_add_epi64(f1, b2); \
    f1 = _mm256_add_epi64(f1, f2); \
    f4 = _mm256_xor_si256(f4, f1); \
    f1 = _mm256_add_epi64(f1, b3); \
    f4 = _mm256_roti_epi64(f4, -32); \
    f3 = _mm256_add_epi64(f3, f4); \
    f2 = _mm256_xor_si256(f2, f3); \
    f2 = _mm256_roti_epi64(f2, -24); \
    row1 = _mm256_add_epi64(f1, f2); \
    f4 = _mm256_xor_si256(f4, row1); \
    f4 = _mm256_roti_epi64(f4, -16); \
    f3 = _mm256_add_epi64(f3, f4); \
    f2 = _mm256_xor_si256(f2, f3); \
    f2 = _mm256_roti_epi64(f2, -63); \
    row4 = _mm256_permute4x64_epi64(f4, _MM_SHUFFLE(0,3,2,1)); \
    row3 = _mm256_permute4x64_epi64(f3, _MM_SHUFFLE(1,0,3,2)); \
    row2 = _mm256_permute4x64_epi64(f2, _MM_SHUFFLE(2,1,0,3));
...
#define ROUND(r) \
    ...
    LOAD_MSG_ ##r ##_3(b2); \
    LOAD_MSG_ ##r ##_4(b3); \
    G3(ymm0,ymm1,ymm2,ymm3,b0,b1,b2,b3);
...
#define GATHER_ROUND(msg) \
  ...
  { \
    ...
    b1 = _mm256_i32gather_epi64((void *)msg, LOAD128(&indices[16*i +  4]), 8); \
    b2 = _mm256_i32gather_epi64((void *)msg, LOAD128(&indices[16*i +  8]), 8); \
    b3 = _mm256_i32gather_epi64((void *)msg, LOAD128(&indices[16*i + 12]), 8); \
    G3(ymm0,ymm1,ymm2,ymm3,b0,b1,b2,b3); \
    /*G1(ymm0,ymm1,ymm2,ymm3,b0); \
    G2(ymm0,ymm1,ymm2,ymm3,b1);*/ \
    /*DIAGONALIZE(ymm0,ymm1,ymm2,ymm3); */\
    /*G1(ymm0,ymm1,ymm2,ymm3,b0); \
    G2(ymm0,ymm1,ymm2,ymm3,b1);*/ \
    /*UNDIAGONALIZE(ymm0,ymm1,ymm2,ymm3); */\
